...
const ROLE_LINKS = {
  jefe_cuadrilla: ['/solicitudes', '/recepcion', '/logistica'],
  enc_alimentacion: ['/aprobacion', '/trazabilidad'],
  bodega: ['/despacho', '/inventario'],
  admin: ['/solicitudes', '/recepcion', '/aprobacion', '/despacho', '/inventario', '/trazabilidad', '/logistica'],
  voluntario: ['/logistica'],
};
...
export default function Sidebar() {
  ...
  const initial = user?.name ? user.name[0].toUpperCase() : (user?.rut ? user.rut[0].toUpperCase() : 'U');
      ...
      <aside className={`sidebar${mobileOpen ? ' open' : ''}`}>
        ...
        <div className="sidebar-user">
          <div className="sidebar-user-info">
            ...
            <span className="sidebar-user-email">{user?.name || user?.rut || 'Usuario'}</span>
          </div>
